const calendarQuery =
  "https://fhm6z54x.api.sanity.io/v2025-07-29/data/query/production?query=%7B%27events%27%3A*%5B_type+%3D%3D+%27event%27%5D%2C%27images%27%3A*%5B_type+%3D%3D+%22sanity.imageAsset%22%5D%7D&perspective=published";
  ...
  fetchData(calendarQuery).then((data) => {
    ...
    var calendar = new FullCalendar.Calendar(cal, {
      ...
      headerToolbar: {
        ...
        center: "title navToHostYourOwnEventButton",
